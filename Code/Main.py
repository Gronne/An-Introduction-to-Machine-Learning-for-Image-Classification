...
mnist_img_train_PCA, model = DataTransformers.PCA.tranform(mnist_img_train, 2)
mnist_img_test_PCA, _ = DataTransformers.PCA.tranform(mnist_img_test, model)

#Transform ORL Data
orl_img_train_PCA, model = DataTransformers.PCA.tranform(orl_img_train, 2)
orl_img_test_PCA, _ = DataTransformers.PCA.tranform(orl_img_test, model)
...
print(f"NCCC - MNIST Full Accuracy: {accuracy_MNIST[0]}")
#PCA applied
...
print(f"NCCC - ORL Full Accuracy: {accuracy_ORL[0]}")
#PCA applied
...
print(f"NCCC - ORL PCA Accuracy: {accuracy_ORL_PCA[0]}")
...
for nr_sub_classes in sets:
    ...
    print(f"NSCCC({nr_sub_classes}) - MNIST Full Accuracy: {accuracy_MNIST[0]}")
    #PCA applied
    ...
    print(f"NSCCC({nr_sub_classes}) - MNIST PCA Accuracy: {accuracy_MNIST_PCA[0]}")
    ...
    print(f"NSCCC({nr_sub_classes}) - ORL Full Accuracy: {accuracy_ORL[0]}")
    #PCA applied
    ...
    print(f"NSCCC({nr_sub_classes}) - ORL PCA Accuracy: {accuracy_ORL_PCA[0]}")



#Exercise 3 - Nearest Neighbor classifier
properties = {'neighbors': 1, 'density': 0.0005} #Hyper parametre: Distance function, neighbors, density, density function, strength function
#--------MNIST--------
#Full dimensionality
...
print(f"NNC - MNIST Full Accuracy: {accuracy_MNIST[0]}")
#PCA applied
...
print(f"NNC - MNIST PCA Accuracy: {accuracy_MNIST_PCA[0]}")
...
print(f"NNC - ORL Full Accuracy: {accuracy_ORL[0]}")
#PCA applied
...
print(f"NNC - ORL PCA Accuracy: {accuracy_ORL_PCA[0]}")
...
print(f"PB - MNIST Full Accuracy: {accuracy_MNIST[0]}")
#PCA applied
...
print(f"PB - MNIST PCA Accuracy: {accuracy_MNIST_PCA[0]}")
...
print(f"PB - ORL Full Accuracy: {accuracy_ORL[0]}")
#PCA applied
...
print(f"PB - ORL PCA Accuracy: {accuracy_ORL_PCA[0]}")
...
print(f"PLS - MNIST Full Accuracy: {accuracy_MNIST[0]}")
#PCA applied
...
print(f"PLS - MNIST PCA Accuracy: {accuracy_MNIST_PCA[0]}")
...
print(f"PLS - ORL Full Accuracy: {accuracy_ORL[0]}")
#PCA applied
...
print(f"PLS - ORL PCA Accuracy: {accuracy_ORL_PCA[0]}")